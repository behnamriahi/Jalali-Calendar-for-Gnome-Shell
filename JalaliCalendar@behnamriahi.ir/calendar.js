...
Calendar.prototype = {
    ...
    _init: function () {
        ...
        this._selectedDate = JDate.JDate.gregorianToJalali(
    ...
    _update: function () {
        ...
        if (this._selectedDate.year === now.year) {
            this._monthLabel.text = JDate.JDate.p_month_names[this._selectedDate.month - 1];
        } else {
            this._monthLabel.text = JDate.JDate.p_month_names[this._selectedDate.month - 1] + ' ' +
        ...
        iter = JDate.JDate.jalaliToGregorian(iter.year, iter.month, 1);
        ...
        while (true) {
            let p_iter = JDate.JDate.gregorianToJalali(
                iter.getFullYear(),
                iter.getMonth() + 1,
                iter.getDate()
            );
        ...
        // find gregorian date
        let g_selectedDate = JDate.JDate.jalaliToGregorian(
        ...
        // find jalali date of today
        let h_selectedDate = JalaliDate.JalaliDate.toJalali(
        ...
        // add jalali date
        if (Schema.get_boolean('jalali-display')) {
