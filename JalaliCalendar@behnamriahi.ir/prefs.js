...
const App = new Lang.Class({
    ...
    _init: function () {
        ...
        this.vbox1.add(item);
        Schema.bind('jalali-display', item, 'active', Gio.SettingsBindFlags.DEFAULT);
        ...
        hbox.add(format);
        this.vbox1.add(hbox);
        format.set_text(Schema.get_string('jalali-display-format'));
        format.connect('changed', function (innerFormat) {
            Schema.set_string('jalali-display-format', innerFormat.text);
        });
        ...
        let info = new Gtk.Label({
            label: _('<span size="small">More info,\nContact: behnamriahi88@gmail.com\nWebSite: behnamriahi.ir\nGitHub: github.com/behnamriahi</span>'),
            use_markup: true
        });
        this.vbox1.add(info);
